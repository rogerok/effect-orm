...
**E3.4: Repository — три метода поиска проверены на обычных значениях, далее `save`.**
...
Nullable-условия, пустой фильтр и остальные методы репозитория пока не проверены.
