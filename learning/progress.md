...
**Урок 4 — E4.4, оптимистический контроль конкурентных изменений.**

## Текущая задача

**Условное обновление по версии и `OptimisticLockError` проверены; интеграция в Repository ещё не начата.**
